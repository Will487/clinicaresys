...
public class CidadeDAO implements GenericDAO {
    ...
    public Boolean inserir(Object objeto) {
        ...
        try{
                ...
                return true;
                    ...
                    try{
                        System.out.println("Problemas ao cadastrar a ! Erro: " + ex.getMessage());
                        ex.printStackTrace();
                        conexao.rollback();
    ...
    public String listarJSON(){
        ...
        try {
            ...
            while(rs.next()){
                if (i>0) strJson+=",";
                strJson += "{\"idCidade\":"+rs.getInt("idcidade")+","
            ...
            System.out.println("Problemas ao Listar Cidade!Erro: " + e.getMessage());
            e.printStackTrace();
        }
