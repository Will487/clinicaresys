 ...
 * @author Aluno
 */
@WebServlet(name = "AdministradorCarregar", urlPatterns = {"/AdministradorCarregar"})
public class AdministradorCarregar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            Administrador oAdm = (Administrador) dao.carregar(idAdministrador);
            
            Gson ogson = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
            String jSon = ogson.toJson(oAdm);
