 ...
 * @author Aluno
 */
@WebServlet(name = "ProfsaudeListar", urlPatterns = {"/ProfsaudeListar"})
public class ProfsaudeListar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            GenericDAO dao = new ProfsaudeDAO();
            request.setAttribute("profsaudes", dao.listar());
            GenericDAO oEstadoDAO = new EstadoDAO();
            request.setAttribute("estados", oEstadoDAO.listar());
            request.getRequestDispatcher("/cadastros/profsaude/profsaude.jsp").forward(request, response);
        } catch (Exception ex){
            //ex.printStackTrace();
