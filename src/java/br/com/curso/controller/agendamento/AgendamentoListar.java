...
@WebServlet(name = "AgendamentoListar", urlPatterns = {"/AgendamentoListar"})
public class AgendamentoListar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.getRequestDispatcher("/cadastros/agendamento/agendamento.jsp").forward(request, response);
        } catch (Exception ex){
            //ex.printStackTrace();
