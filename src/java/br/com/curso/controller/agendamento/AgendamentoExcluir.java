 ...
 * @author Admin
 */
@WebServlet(name = "AgendamentoExcluir", urlPatterns = {"/AgendamentoExcluir"})
public class AgendamentoExcluir extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(dao.excluir(idAgendamento)){
                response.getWriter().write("1");
            }else{
                response.getWriter().write("0");
            }
        } catch (Exception e){
            System.out.println("Problemas na Servelet Excluir Agendamento!Erro: " + e.getMessage());
            e.printStackTrace();
        }
    }
