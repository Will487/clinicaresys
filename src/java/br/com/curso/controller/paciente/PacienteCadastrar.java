 ...
 * @author Aluno
 */
@WebServlet(name = "PacienteCadastrar", urlPatterns = {"/PacienteCadastrar"})
public class PacienteCadastrar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{           
            ...
            //gera objeto de paciente
            Paciente oPaciente = new Paciente(idPaciente, permitelogin, situacao, carteirinha,
                    idPessoa, cpfCnpjPessoa, nomePessoa, dataNascimento, oCidade, login, senha, 
                    fotoPessoa);
            //instancia camada dao de paciente    
            PacienteDAO dao = new PacienteDAO();

            if(dao.cadastrar(oPaciente)){
            ...
            System.out.println("Problemas no servelet Cadastrar Paciente!Erro: " + e.getMessage());
            e.printStackTrace();
        }
    }
