 ...
 * @author Aluno
 */
@WebServlet(name = "PacienteListar", urlPatterns = {"/PacienteListar"})
public class PacienteListar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.getRequestDispatcher("/cadastros/paciente/paciente.jsp").forward(request, response);
        } catch (Exception ex){
            //ex.printStackTrace();
