 ...
 * @author Aluno
 */
@WebServlet(name = "PacienteCarregar", urlPatterns = {"/PacienteCarregar"})
public class PacienteCarregar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            Paciente oCli = (Paciente) dao.carregar(idPaciente);
