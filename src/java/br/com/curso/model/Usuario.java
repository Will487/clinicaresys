        ...
        try{
            ...
            if(sessao != null && sessao.getAttributeNames().hasMoreElements()){
                ...
                if (tipoUsuario.equalsIgnoreCase("administrador")){
                    ...
                    {
                       if (recurso.equalsIgnoreCase("/AgendamentoListar2") ||
                            
                            recurso.equalsIgnoreCase("/cadastros/menuHeader.jsp") ||
                            recurso.equalsIgnoreCase("/cadastros/menuFooter.jsp") ||
                               recurso.equalsIgnoreCase("/UsuarioDeslogar") ||    
                            recurso.equalsIgnoreCase("/cadastros/homeLogado.jsp")){
                            //permite acesso ao usuario tipo paciente
                            status=true;
                        }
                    }
                    
                    if (tipoUsuario.equalsIgnoreCase("Profsaude"))
                    {
                        if (recurso.equalsIgnoreCase("/AgendamentoListar2") ||
