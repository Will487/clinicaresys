            ...
            <table id="datatable" class="display">
                <thead>
                    <tr>
                        ...
                        <th align="center">Status Pagamento</th>
                ...
                <tbody>
                    <c:forEach var="despesa" items="${despesas}"> 
                        <tr>
                            ...
                            <td align="center"><fmt:formatNumber value = "${despesa.valorDespesa}" type = "currency"/></td>
                            <td align="center"><fmt:formatNumber value = "${despesa.valorPago}" type = "currency"/></td>
                            <td align="center">
                                <a href="#" id="deletar" title="Excluir" onclick="deletar(${despesa.idDespesa})">
                                    <button class="btn 
                                        ...
                                        <Strong>
                                            <c:out value="${despesa.situacao == 'A' ? 'Não Pago': 'Pago'}"/>
                                        </Strong>
                                    </button></a>
...
<script>
    ...
    function deletar(codigo){
        ...
        Swal.fire({
            ...
            confirmButtonText: 'Sim, desejo alterar o status do Pagamento!',
